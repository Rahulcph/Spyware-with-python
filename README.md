This project demonstrates a simple Spyware by using Python. The Spyware  captures keystrokes on the target  machine and sends them to a designated server over a socket connection.
